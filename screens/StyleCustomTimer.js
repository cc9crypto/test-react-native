...
const StyleCustomTimer = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.styleCustomTimer1, styles.iconLayout]}>
      <View style={[styles.background, styles.backgroundLayout]}>
        ...
        />
        <View style={[styles.backgroundChild, styles.navigationPosition]} />
        <LinearGradient
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("StyleCustomTimer2")}
      >
        <Image
        ...
        />
        <Text style={[styles.text, styles.timerTypo]}>1:30</Text>
        <Image
...
export default StyleCustomTimer;
