...
const StylePoachedSteps = () => {
  return (
    <View style={[styles.stylePoachedSteps, styles.instructions1Bg]}>
      <Image
        style={[styles.hardBoiledBackground1Icon, styles.timerPosition]}
        contentFit="cover"
        source={require("../assets/hardboiledbackground-1.png")}
      />
      <View style={[styles.stylePoachedStepsChild, styles.timerPosition]} />
      ...
      <View style={[styles.navigation, styles.timerPosition]}>
      ...
      <View style={[styles.stylePoachedStepsItem, styles.vectorIconPosition]} />
          ...
          <View style={styles.title1FlexBox}>
            <View style={[styles.frameContainer, styles.timerParentFlexBox]}>
              <View style={[styles.wrapper, styles.wrapperLayout]}>
                <Text style={[styles.text3, styles.mFlexBox]}>1</Text>
              </View>
            ...
            <View style={[styles.frameContainer, styles.timerParentFlexBox]}>
              <View style={[styles.container, styles.wrapperLayout]}>
                <Text style={[styles.text3, styles.mFlexBox]}>2</Text>
              </View>
              <Text
                style={[styles.bodyCopy, styles.bodyFlexBox]}
              >{`Add 2 tsp of white vinegar to the water. `}</Text>
            </View>
            <View style={[styles.frameContainer, styles.timerParentFlexBox]}>
              <View style={[styles.container, styles.wrapperLayout]}>
                <Text style={[styles.text3, styles.mFlexBox]}>3</Text>
              </View>
              <Text
                style={[styles.bodyCopy, styles.bodyFlexBox]}
              >{`One at a time, crack an egg into a bowl and gently slip into the water. `}</Text>
            </View>
            <View style={[styles.frameContainer, styles.timerParentFlexBox]}>
              <View style={[styles.container, styles.wrapperLayout]}>
                <Text style={[styles.text3, styles.mFlexBox]}>4</Text>
              </View>
              <Text style={styles.bodyFlexBox}>
                <Text style={styles.bodyCopyTxtContainer}>
                  <Text style={styles.cookEggsFor}>{`Cook eggs for `}</Text>
                  <Text style={styles.mTypo}>{`3 minutes `}</Text>
                  <Text style={styles.cookEggsFor}>{`for a runny yolk, `}</Text>
                  <Text style={styles.mTypo}>4 minutes</Text>
                  <Text
                    style={styles.cookEggsFor}
                  >{` for a slightly set yolk and `}</Text>
                  <Text style={styles.mTypo}>5 minutes</Text>
                  <Text style={styles.cookEggsFor}>{` for a firm yolk. `}</Text>
                </Text>
              </Text>
            </View>
            <View style={[styles.frameContainer, styles.timerParentFlexBox]}>
              <View style={[styles.container, styles.wrapperLayout]}>
                <Text style={[styles.text3, styles.mFlexBox]}>5</Text>
              </View>
              <Text
                style={[styles.bodyCopy, styles.bodyFlexBox]}
              >{`Remove eggs with a slotted spoon and drain on a paper towel. `}</Text>
            </View>
          </View>
        </View>
        <Image
...
export default StylePoachedSteps;
