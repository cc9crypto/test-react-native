...
const StyleSoftBoiled = () => {
  return (
    <View style={styles.styleSoftBoiled}>
      <View style={[styles.hardBoiledBackground2Parent, styles.hardPosition]}>
        <Image
          style={[styles.hardBoiledBackground2Icon, styles.hardPosition]}
          contentFit="cover"
...
export default StyleSoftBoiled;
